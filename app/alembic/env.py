...
def run_migrations_online() -> None:
    ...
    """
    # Override the URL from the config with the one from your app
    from core import settings
    config.set_main_option("sqlalchemy.url", settings.get_config().SQLALCHEMY_DATABASE_URL)
    ...
    with connectable.connect() as connection:
        context.configure(
            ...
            target_metadata=target_metadata,
            # Add these options to handle existing tables
            compare_type=True,
